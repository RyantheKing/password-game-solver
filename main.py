...
def play_game():
    ...
    controller.type_password_html(solver.password_to_html(0, password))
    ...
    controller.type_password_html(solver.password_to_html(1, password))
    ...
    controller.type_password_html(solver.password_to_html(2, password))
    ...
    solver.birth_paul()
    password, old_password = solver.generate_password(4, captcha, location, chess_move, link)
    ...
    password = solver.generate_password(5, captcha, location, chess_move, link, color, unused)
